...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        img_background = Image.open("C:\\Users\\pc\PycharmProjects\\robot2\\images\\bg.png")
        ...
        self.obstacle1 = self.canvas_widget.create_rectangle(
            obstacle1_center[0] - 10, obstacle1_center[1] - 10,
            obstacle1_center[0] + 10, obstacle1_center[1] + 10,
        ...
        self.obstacle2 = self.canvas_widget.create_rectangle(
            obstacle2_center[0] - 10, obstacle2_center[1] - 10,
            obstacle2_center[0] + 10, obstacle2_center[1] + 10,
            outline='grey', fill='#00BFFF')
